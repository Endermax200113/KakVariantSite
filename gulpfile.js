...
gulp.task("files", done => {
	...
	gulp.src(["site/**/*.*", "!site/**/*.{sass,js,html,png,jpg,webp,raw,jpeg,ttf,svg,gif}"])
...
gulp.task("images", done => {
	...
	gulp.src("site/img/**/*.{png,jpg,webp,raw,svg,gif}")
		.pipe(gulp.dest(donePath.img))
		.pipe(browserSync.stream());
...
gulp.task("watch", () => {
	...
	gulp.watch(["site/**/*.*", "!site/**/*.{sass,js,html,png,jpg,webp,raw,jpeg,ttf,svg,gif}"], gulp.parallel("files"));
	gulp.watch("site/img/**/*", gulp.parallel("images"));
	gulp.watch("site/fonts/**.ttf", gulp.parallel("fonts"));
});

gulp.task("default", gulp.parallel("images", "styles", "scripts", "browser", "watch"));